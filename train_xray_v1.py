...
# Example: train on lot1 + lot2, validate on lot3.
HOLDOUT_LOT = "lot2"
...
def train_all_lots_model():
    print("=" * 60)
    print("TRAIN RESNET18 TRANSFER MODEL")
    print("=" * 60)
    ...
    print(f"Train negative:         {total_negative}")
    ...
    best_model_path = models_dir / f"best_resnet18_holdout_{HOLDOUT_LOT}.pth"
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        train_metrics = compute_binary_metrics(train_outputs_all, train_labels_all)
