# train_xray_v3_all_lots_split.py
# Train ResNet18 transfer-learning model using Lot1, Lot2, Lot3
# Validation is stratified within each lot.
# Goal: train final-ish model using all known lots while monitoring validation performance.
...
def train_all_lots_model():
    ...
    best_model_path = models_dir / "best_screening_resnet18_all_lots_split.pth"
    fallback_model_path = models_dir / "best_fallback_resnet18_all_lots_split.pth"
    last_model_path = models_dir / "last_resnet18_all_lots_split.pth"
